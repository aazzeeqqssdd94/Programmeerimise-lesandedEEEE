namespace CYCLES
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 1. "вычисляй до суммы"
            // создай переменную "целоеЧисло", присвой ей значение 0
            // напиши do-while цикл
            // в цикле вычитай из переменной "целоеЧисло" 2
            // и выводи переменную "целоеЧисло"
            // -> условие do-while: проверять, что "целоеЧисло" больше -31
            // после цикла выведи сообщение "цикл завершён"

            /* Пример:
            int целоеЧисло = 0;
            do {
                целоеЧисло -= 2;
                Console.WriteLine(целоеЧисло);
            } while (целоеЧисло > -31);
            Console.WriteLine("цикл завершён");
            */

            // 2. "удлинять сообщение"
            // создай переменную "сообщение" с пустой строкой ""
            // напиши do-while цикл
            // в цикле спрашивай пользователя: "пожалуйста, добавьте следующую часть сообщения"
            // добавляй введённый пользователем текст к переменной "сообщение"
            // выводи текущее значение переменной "сообщение"
            // -> условие do-while: проверять длину строки .Length, если длина > 140, цикл завершить
            // после цикла выведи сообщение "это сообщение больше не поместится в Twitter, напиши меньше fam"

            /* Задания с while */

            // 1. "пока нет опасности"
            // создай переменную "уровеньCO2" с плавающей точкой, начальное значение 0.0f
            // напиши while цикл
            // -> условие while: "уровеньCO2" < 40.000
            // в цикле выводи сообщение "какой уровень CO2?"
            // считывай значение от пользователя и присваивай переменной "уровеньCO2"
            // проверяй, если введённое значение < 40.000, выводи сообщение пользователю, что прямой опасности нет
            // после цикла выведи сообщение "эвакуируйтесь, уровень углекислого газа слишком высокий"

            /* 
             * NB программа должна работать до тех пор, пока введённое значение < 40.000
             */

            // 2. "стрелок"
            // создай переменную "маленькийЧеловек" типа int, начальное значение 0
            // создай переменную "ответ" типа string, начальное значение ""
            // напиши while цикл
            // -> условие while: "маленькийЧеловек" <= 5 ИЛИ "ответ" == "да"
            // в цикле спрашивай пользователя: "хочешь выпустить стрелу в маленького человечка?"
            // считывай ответ пользователя и присваивай переменной "ответ"
            // проверяй if, если "ответ" == "да", то:
            //   спрашивай пользователя: "сколько стрел выпустишь?"
            //   добавляй введённое значение к переменной "маленькийЧеловек"
            // после цикла проверяй: если "маленькийЧеловек" < 5, выведи "маленький человечек жив :D"
            // иначе выведи "ты убил маленького человечка :c"

            /* Задания с for */

            // 1. "вывод чисел"
            // создай переменную "сколько" типа int, начальное значение 0
            // спроси пользователя: сколько чисел он хочет
            // присвой введённое значение переменной "сколько"
            // напиши for цикл, условие i < "сколько"
            // в цикле выводи i+1 (чтобы счёт начинался с 1)
            // после цикла выведи "цикл завершён"

            // 2. "квадрат"
            // создай переменную "сторонаКвадрата" типа int, начальное значение 0
            // спроси пользователя: какого размера квадрат он хочет
            // присвой введённое значение переменной "сторонаКвадрата"
            // напиши for цикл, условие i < "сторонаКвадрата"
            // внутри цикла создай строковую переменную "этаСтрока" с пустым значением
            // внутри этого цикла напиши ещё один for цикл, условие j < "сторонаКвадрата"
            // внутри внутреннего цикла добавляй к "этаСтрока" значение "HH"
            // после внутреннего цикла выведи "этаСтрока"
            // после внешнего цикла выведи "циклы завершены"

            /* Задания с foreach + list */

            // 1. "большие суммы"
            // создай массив из пяти элементов: 1, 50, 10, 15, 20
            // напиши foreach цикл для элементов массива
            // внутри цикла проверь if элемент > 15
            // если да, выведи элемент
            /* подсказка:
             * если всё написано правильно, должны быть выведены элементы 20 и 50
             */

            // 2. "суммирование"
            // создай массив из пяти элементов: 343, 686, 2300, 4439, 6996
            // создай переменную типа int с начальным значением 0
            // напиши foreach цикл для элементов массива
            // внутри цикла добавляй текущий элемент к переменной int
            // после цикла выведи значение переменной int
